...
import goronald.web.id.myfavouritemovie.adapter.UpComingAdapter;
import goronald.web.id.myfavouritemovie.entity.Movie;

public class UpComingAsyncTaskLoader extends AsyncTaskLoader<ArrayList<Movie>> {

    private ArrayList<Movie> mData;
    private boolean mHasResult = false;
    private int mPage;

    public UpComingAsyncTaskLoader(Context context, Bundle args) {
        super(context);
        onContentChanged();
    ...
    public ArrayList<Movie> loadInBackground() {
        ...
        String url = BuildConfig.BASE_URL + "upcoming?api_key=" +
